...
public class VisionTestBlueWarehouse extends LinearOpMode
{
    ...
    public static class DeterminationPipeline extends OpenCvPipeline
    {
        ...
        public Mat processFrame(Mat input)
        {
            ...
            {
                if (side){
                    position = VisionTestBlueWarehouse.DeterminationPipeline.MarkerPosition.CENTER;
                }
                else{
                    position = VisionTestBlueWarehouse.DeterminationPipeline.MarkerPosition.LEFT;
                }
                ; // Record our analysis
            ...
            {
                if (side){
                    position = VisionTestBlueWarehouse.DeterminationPipeline.MarkerPosition.RIGHT;
                }
                else {
                    position = VisionTestBlueWarehouse.DeterminationPipeline.MarkerPosition.CENTER;
                }
