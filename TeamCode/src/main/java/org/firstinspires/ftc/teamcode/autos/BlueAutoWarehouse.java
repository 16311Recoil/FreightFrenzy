...
public class BlueAutoWarehouse extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
       ...
       /* double curAngle = robot.getSensors().getFirstAngle();
        ...
        robot.getDrivetrain().turnToPID(0, robot.getSensors(), 0.4,2.5);
        ...
        robot.getDrivetrain().moveInchesAngleLock(-40, power + 0.25, true, robot.getSensors().getFirstAngle(), 5);
        Thread.sleep(800);

        // Adjust rotation back to properly use moveInches #2
        robot.getDrivetrain().turnToPID(0, robot.getSensors(), 0.4,1.5);
        ...
        robot.getDrivetrain().moveInchesAngleLock(-16, power + 0.2, true, robot.getSensors().getFirstAngle(), 5);
        // Setup for teleop
        robot.getManip().rotateClawDown();
        robot.getManip().mechRelease();
        Thread.sleep(2000);
